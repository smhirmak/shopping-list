export const deleteShoppingListPopup = (t: (e: string) => void) => ({
  ...
  customClass: {
    container: 'z-1500',
    confirmButton: 'order-2 bg-error w-[45%] text-white py-3 text-lg font-semibold rounded-md',
    cancelButton: 'order-1 bg-transparent border border-tra-neutral-black text-tra-neutral-black w-[45%] py-3 text-lg font-semibold rounded-md',
...
export const deleteProductPopup = (t: (e: string) => void) => ({
  ...
  customClass: {
    container: 'z-1500',
    confirmButton: 'pointer-events-auto order-2 bg-error w-[45%] text-white py-3 text-lg font-semibold rounded-md',
    cancelButton: 'pointer-events-auto order-1 bg-transparent border border-tra-neutral-black text-tra-neutral-black w-[45%] py-3 text-lg font-semibold rounded-md',
    actions: 'w-full flex justify-between px-8 py-4',
    title: 'text-2xl text-tra-neutral-black',
    popup: 'rounded-3xl bg-tra-neutral-light',
    htmlContainer: '!text-tra-neutral-black',
